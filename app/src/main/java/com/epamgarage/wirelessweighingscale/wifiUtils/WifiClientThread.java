package com.epamgarage.wirelessweighingscale.wifiUtils;
...
public class WifiClientThread implements Runnable {
    ...
    public void showMessage(String message,String macAddress){
        handler.post(() -> {
            MainActivity.Companion.getWeighingScaleListAdapter().getWifiTextView().setText(message.trim());
            MainActivity.Companion.getWeighingScaleListAdapter().getWifiTextViewName().setText(macAddress.trim());
        });
    }
